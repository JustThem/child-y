...
function backColor1(e) {
    ...
    // let idList = e.target.parentNode.parentNode.children[1].children;
    var num = e.target.innerHTML.split('赞同')[1];
    ...
    if (isLike === 'true') {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                e.target.innerHTML = '<span id="one" onclick="backColor11(event)"></span>&nbsp;&nbsp;&nbsp;赞同 ' + data;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                e.target.innerHTML = '<span id="one" onclick="backColor11(event)"></span>&nbsp;&nbsp;已赞同 ' + data;
...
function backColor11(e) {
    let pid = e.target.parentNode.parentNode.parentNode.children[0].innerText;
    var num = e.target.parentNode.innerText.split('赞同')[1];
    ...
    if (isLike === 'true') {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                e.target.parentNode.innerHTML = '<span id="one" onclick="backColor11(event)"></span>&nbsp;&nbsp;&nbsp;赞同 ' + data;
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                num++;
                r.innerHTML = '<span id="one" onclick="backColor11(event)"></span>&nbsp;&nbsp;已赞同 ' + data;
    ...
    $.ajax({
        ...
        success: function (data) {
            for (let i = 0; i < data['data'].length; i++) {
                ...
                let w = data['data'][i][0];
                let b = data['pid'];
                var index = $.inArray(w, b);
                if (index > 0){
                    divButton1.innerHTML = '<span></span>&nbsp;&nbsp;&nbsp;已赞同 ' + like;
                    divButton1.className = 'like-but';
                    divButton1.value = 'true'
                }else {
                    divButton1.innerHTML = '<span></span>&nbsp;&nbsp;&nbsp;赞同 ' + like;
                    divButton1.className = 'but1';
                ...
                divButton1.onclick = function () {
                    let e = this;
                    let pid = e.parentNode.parentNode.children[0].innerText;
                    var num = e.innerHTML.split('赞同')[1];
                    let isLike = e.value;
                    if (isLike === 'true') {
                        e.value = 'false';
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                e.innerHTML = '<span id="one" onclick="backColor11(event)"></span>&nbsp;&nbsp;&nbsp;赞同 ' + data;
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                e.style.color = 'white';
                                e.innerHTML = '<span id="one" onclick="backColor11(event)"></span>&nbsp;&nbsp;已赞同 ' + data;
                ...
                idSpan.innerText = data['data'][i][0];
